...
- Cloudflare Workers Logs 已包含 requestId、URL、outcome、版本等平台信息；`D=true` 只补充 VLESS 目标、fallback、UDP DoH 错误等应用层信息，且可能包含目标地址，排障后建议恢复为 `false`
